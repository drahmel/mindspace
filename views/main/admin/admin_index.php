...
<form method="POST" action="/mindspace/add">
	...
	<input name="x" placeholder="x" value="<?php echo rand(-20,20); ?>" />
	<input name="y" placeholder="y" value="<?php echo rand(-20,20); ?>" />
	<input name="z" placeholder="z" value="<?php echo rand(-20,20); ?>" />
	<select name="type">
